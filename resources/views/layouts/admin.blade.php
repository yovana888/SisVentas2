...
<body>
	...
	<div data-scrollbar="true" data-height="100%">
		...
		<ul class="nav">
			...
			@else
			<li><a href="{{url('escritorio_suc')}}"><i class="ti-home"></i><span>Home</span></a></li>
			@endif
			...
			<li class="has-sub">
				...
				<ul class="sub-menu">
					...
					<li><a href="{{url('pedidos/proveedor')}}">Pedidos Proveedor</a></li>
					@else
					<li><a href="{{url('pedidos/realizados')}}">Pedidos Realizados</a></li>
					<li><a href="{{url('pedidos/entrantes')}}">Pedidos Entrantes</a></li>
					@endif
			...
			<li class="has-sub">
				...
				<ul class="sub-menu">
					...
					<li><a href="{{url('consultas/ventas')}}">Consultas Ventas</a></li>
				</ul>
			</li>
			@endif
			...
			<li class="has-sub">
				...
				<ul class="sub-menu">
					...
					<li><a href="{{url('consultas/compras')}}">Consultas Compras</a></li>
				</ul>
			</li>
			@endif
			...
			<li><a href="{{url('caja')}}"><i class="ti-receipt"></i><span>Caja</span></a></li>
			@endif
			@if(Auth::user()->m_kardex=='1')
			<li><a href="{{url('consultacaja')}}"><i class="ti-agenda"></i><span>Consulta Caja</span></a></li>
			@endif

    ...
    <div class="modal-dialog">
        <div class="modal-content" style="border-radius: 0px 0px 0px 0px;">
            <div class="modal-header"  style="background:#444; height:70px;">
                ...
                <span aria-hidden="true"><i class="ti-close" style="color:#fff"></i></span>
                 ...
                 <h3 class="modal-title " style="color:#fff; "><i class="ti-pencil"></i> Editar Cliente</h3>
            </div>
        ...
        <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
            ...
            <div class="form-group">
                ...
                <input type="text" style="color:#888;" name="cuenta" value="{{$per->cuenta}}" class="form-control" placeholder="Email...">
            </div>
        </div>
          <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
            <div class="form-group">

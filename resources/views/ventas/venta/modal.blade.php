		...
		<div class="modal-content" style="border-radius: 0px 0px 0px 0px;">
			<div class="modal-header" style="background:#444; height:70px;">
				...
				aria-label="Close">
                 ...
                 <h3 class="modal-title " style="color:#fff; "><i class="ti-alert"></i> Anular Venta</h3>
			</div>
			<div class="modal-body" style="background:#f8f8f8; ">
					<h4 class="text-muted">Confirme si desea Anular la venta, estas accion es irreversible</h4>
			</div>

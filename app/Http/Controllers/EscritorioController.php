...
class EscritorioController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('escritorio',["anuladas"=>$anuladas,"aceptadas"=>$aceptadas,"faltantes"=>$faltantes,"pagadas"=>$pagadas,"mascomprado"=>$mascomprado,"comprasdias"=>$comprasdias,"comprasmes"=>$comprasmes,"detalles"=>$detalles,"proveedores"=>$proveedores,"total1"=>$total_pro,"comprashoy"=>$comprashoy,"articulos"=>$articulos]);

    ...
    <div class="panel-heading" style="">
      ...
      <div class="panel-body">
       ...
       <div class="panel-footer clearfix">
        @include('almacen.articulo.create2')
        <a href=""  data-target="#modal-plus" data-toggle="modal"><button class="btn btn-pink btn-sm pull-left m-l-5" >Nuevo Articulo</button></a>

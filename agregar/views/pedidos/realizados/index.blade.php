...
<ul class="breadcrumb " style="margin-left: 3%; ">
  ...
  <div class="panel panel-default " style="margin-left: 3%; margin-right :3%;" id="rem1">
        ...
        <!--plus1 pedidos a sucursales ... plus2 pedidos a proveedor-->
        ...
        <!--Pedido Proveedor-->
         @if(Auth::user()->id_s=='3')
         <!--ya que crearemos otra interfaz para q haga los pedidos directamente para su proveedor en base  a su stok bajo-->
         @else

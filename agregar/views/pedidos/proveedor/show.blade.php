...
<div class="modal-dialog" style="width:60% !important; ">
  ...
  {!!Form::model($ped,['method'=>'PATCH','route'=>['pedidos.proveedor.update',$ped->idnotificacion_pedido]])!!}
                        ...
                        <tr  style="color: #888;" >   
                            ...
                            <td>
                              ...
                              <button type="button" class="btn btn btn-xs" style="background: rgba(170, 102, 200, 0.9); color: #fff; margin-left:10px;" value="{{$del->iddetalle_pedido}}" id="btn_edit_{{$del->iddetalle_pedido}}" onclick="fnProcesa(this)"><i class="ti-pencil"></i></button>
                                @if($ped->estado=='En espera' || $ped->estado=='Acep. Parcial')
                               <button type="button" class="btn btn btn-xs" style="background:rgba(0, 200, 83, 0.9); color: #fff; margin-left:10px;" value="{{$del->iddetalle_pedido}}" id="btn_save_{{$del->iddetalle_pedido}}" onclick="fnProcesa2(this)"><i class="ti-save"></i></button>
                                @else
                                <button type="button" disabled class="btn btn btn-xs" style="background:rgba(0, 200, 83, 0.9); color: #fff; margin-left:10px;"><i class="ti-save"></i></button>
                                @endif

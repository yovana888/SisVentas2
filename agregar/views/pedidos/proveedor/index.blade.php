...
<ul class="breadcrumb " style="margin-left: 3%; ">
  ...
  <div class="panel panel-default " style="margin-left: 3%; margin-right :3%;" id="rem1">
            ...
            <table id="datatables-default" class="table  m-1" >
              ...
              <tbody>
                @foreach($pedidos as $ped)
                  <tr style="color: #888;">
                    <td >{{$ped->idnotificacion_pedido}}</td>
                    <td>{{$ped->fecha_hora}}</td>
                        ...
                        @endforeach
                         ...
                         <td>{{$ped->nota}}</td>
                         <td> 
                          @include('pedidos.proveedor.show',[$details,$ped->idemisor])
        ...
        <div class="panel-footer clearfix">
         @include('pedidos.proveedor.show2',[$proveedores2])
         <a href=""  data-target="#modal-resumen" data-toggle="modal"><button class="btn btn-pink btn-sm pull-left m-l-5" style="">Resumen</button></a>

          @include('pedidos.proveedor.plus2',[$misarticulos_sin,$misarticulos_con])

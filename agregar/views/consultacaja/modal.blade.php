...
{{Form::Open(array('action'=>array('ConsultaCajaController@destroy',$ca->idcaja),'method'=>'delete'))}}
	<div class="modal-dialog">
		<div class="modal-content" style="border-radius: 0px 0px 0px 0px;">
			<div class="modal-header" style="background:#444; height:70px;">
				...
				<h3 class="modal-title " style="color:#fff; "><i class="ti-alert"></i>Cerrar Caja</h3>
			</div>
			<div class="modal-body" style="background:#f8f8f8; border-radius: 0px 0px 10px 10px; ">
					<h4 class="text-muted">Confirme si desea cerrar esta caja, esta acción es irreversible</h4>
			</div>

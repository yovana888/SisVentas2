								  ...
								  <table class="table">
								    ...
								    @foreach($articulos as $art)
								      <tr style="color: #777;">
								        ...
								        <td><span class="label label-success" style="font-size: 12px;">{{$art->precio_venta}}</span></td>
								      </tr>
								      @endforeach
								    </tbody>
								  </table>
...
<div class="row"  style="padding-left:30px; padding-right:20px;">
	<div class="col-md-5">
			<div class="row">
					<div class="panel panel-default">
						<div class="panel-heading">
							<h3 class="panel-title" style="color: #777;">Articulos más Vendidos</h3>
							<span class="pull-right clickable"><i class="glyphicon glyphicon-chevron-up"></i></span>
						</div>
						<div class="panel-body">
							 <div class="table-responsive">          
			...
			<div class="row">
				 <div class="col-md-12">
				 	<div class="row">
					      ...
					      <div class="alert alert-danger m-b-10">
								<strong><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">¡Aviso! </font></font></strong><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">Ventas Anuladas en este mes: <span class="label label-pink">7</span>
				 ...
				 <div class="row">
					      ...
					      <div class="alert alert-warning m-b-10">
								<strong><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">¡Aviso! </font></font></strong><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">Ventas por pagar en este mes: <span class="label label-warning">2</span>
				  ...
				  <div class="row">
					      ...
					      <div class="alert alert-success m-b-10">
								<strong><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">¡Aviso! </font></font></strong><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">Ventas pagadas en este mes: <span class="label label-success">2</span>
	...
	<div class="col-md-7">
		<div class="panel panel-default">
						<div class="panel-heading">
							<h3 class="panel-title" style="color: #777;">Gráfico de Ventas-Meses</h3>
							<span class="pull-right clickable"><i class="glyphicon glyphicon-chevron-up"></i></span>
						</div>
						<div class="panel-body">
...
<div class="page-notification  bounceInRight animated page-notification-inverse">
	...
	<div class="notification-info">
		...
		<p class="notification-desc">{{$det->stock}} {{$det->medida_stock_gn}}(s) con {{$det->cantidad_detalle}} {{$det->medida_stock_det}}</p>
	</div>
